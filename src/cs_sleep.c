...
/* = { .type = 1, .size = 96, .config = 3, 
{.sample_period = 1, .sample_freq = 1}, .sample_type = 39, 
.read_format = 0, .disabled = 1, .inherit = 0, .pinned = 0, 
.exclusive = 0, .exclude_user = 0, .exclude_kernel = 0, .exclude_hv = 0, .exclude_idle = 0, 
.mmap = 1, .comm = 1, .freq = 0, .inherit_stat = 0, .enable_on_exec = 1, 
.task = 1, .watermark = 0, .precise_ip = 0, .mmap_data = 0,
  .sample_id_all = 1, .exclude_host = 0, .exclude_guest = 1, .exclude_callchain_kernel = 0, .exclude_callchain_user = 0, 
  .mmap2 = 1, .comm_exec = 1, 
  .wakeup_events = 0, .wakeup_watermark = 0}; 
*/
